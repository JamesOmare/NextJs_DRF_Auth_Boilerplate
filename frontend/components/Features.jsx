    ...
    const features = [
        {
          ...
          },
          {
            ...
            description:
              "Choose from 100s of designer made templates, and change anything you want to create your professional eCommerce website.",
            image: "/assets/images/icon-fast.png",
            alt: "Customizable",
          },
          {
            name: "Integrations",
            description:
              "Choose from 100s of designer made templates, and change anything you want to create your professional eCommerce website.",
            image: "/assets/images/icon-journey.png",
            alt: "Customizable",
          },
          {
            name: "Full Stack",
            description:
              "Choose from 100s of designer made templates, and change anything you want to create your professional eCommerce website.",
            image: "/assets/images/icon-layer.png",
            alt: "Customizable",
          },
          {
            name: "Loyalty",
            ...
            image: "/assets/images/icon-location.png",
            alt: "Customizable",
          },
          {
            name: "Support",
            image: "/assets/images/icon-support-1.png",
